...
hi LineNr guifg=#555753 ctermfg=240 guibg=#000000 ctermbg=0 
hi NonText guifg=#555753 ctermfg=240 guibg=#000000 ctermbg=0 
hi Folded guifg=#555753 ctermfg=240 guibg=#000000 ctermbg=0 gui=bold 
hi FoldeColumn guifg=#555753 ctermfg=240 guibg=#000000 ctermbg=0 gui=bold 
"hi VertSplit	guibg=#ffffff guifg=#ffffff gui=none
hi VertSplit guibg=#c0c0c0 ctermbg=250 guifg=#c0c0c0 ctermfg=250 gui=none 
hi StatusLine guifg=#000000 ctermfg=0 guibg=#ffffff ctermbg=15 gui=none 
hi StatusLineNC guifg=#000000 ctermfg=0 guibg=#C0C0C0 ctermbg=250 gui=none 
...
hi Comment guifg=#888a85 ctermfg=102 
...
" tabs (non gui)
hi TabLine guifg=#AAAAAA ctermfg=248 guibg=#000000 ctermbg=0 gui=none 
hi TabLineFill guifg=#555753 ctermfg=240 guibg=#000000 ctermbg=0 gui=none 
